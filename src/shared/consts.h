...
#define WDAC_POLICY_FILE \
    L"\\systemroot\\system32\\CodeIntegrity\\driversipolicy.p7b"
...
//
// Several valid signed Realtek drivers has invalid checksum set in their PE
// header. This flag will tell KDU to skip it checksum verification at loading
// stage. Note: Windows 7 does check driver checksum to be valid thus such
// drivers will fail to load here.
//
#define KDUPROV_FLAGS_IGNORE_CHECKSUM 0x00000004

//
// Do not set System/Admin-only security descriptor to the provider driver
// device.
//
