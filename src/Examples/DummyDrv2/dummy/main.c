...
NTSTATUS CreateDispatch(_In_ struct _DEVICE_OBJECT* DeviceObject,
    ...
    DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_INFO_LEVEL, "[%s] Create\r\n",
               __FUNCTION__);
...
NTSTATUS CloseDispatch(_In_ struct _DEVICE_OBJECT* DeviceObject,
    ...
    DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_INFO_LEVEL, "[%s] Close\r\n",
               __FUNCTION__);
...
NTSTATUS DriverInitialize(_In_ struct _DRIVER_OBJECT* DriverObject,
    ...
    DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_INFO_LEVEL,
               ...
               __FUNCTION__, HandleToUlong(PsGetCurrentProcessId()),
               ProcessObject, HandleToUlong(PsGetCurrentThreadId()),
               ThreadObject);
...
NTSTATUS DriverEntry(_In_ struct _DRIVER_OBJECT* DriverObject,
    ...
    DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_INFO_LEVEL,
               "[%s] Driver built at %s\r\n", __FUNCTION__,
               __TIMESTAMP__);  // Set DriverModel to allow timestamps.
