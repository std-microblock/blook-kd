...
#pragma warning( \
    disable      \
    : 4054)  // 'type cast' : from function pointer %s to data pointer %s
...
#define PGDEMO_SET_TEST_TYPE \
    CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0800, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
