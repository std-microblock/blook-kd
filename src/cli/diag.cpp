...
NTSTATUS NTAPI EnumObjectsCallback(_In_ POBJECT_DIRECTORY_INFORMATION Entry,
...
NTSTATUS EmptyWorkingSet() {
    ...
    ntStatus =
        NtQueryInformationProcess(NtCurrentProcess(), ProcessQuotaLimits,
                                  &quotaLimits, sizeof(quotaLimits), NULL);
    ...
    return NtSetInformationProcess(NtCurrentProcess(), ProcessQuotaLimits,
                                   &quotaLimits, sizeof(quotaLimits));
}

VOID KDUPrintBooleanValueWithColor(_In_ CONST char* Name, _In_ BOOLEAN Value) {
#define PRINTGRN "\x1B[32m"
#define PRINTWHT "\x1B[37m"

    if (g_ConsoleOutput) {
        printf_s("\t\t%s %s\r\n%s", Name,
                 Value ? PRINTGRN "TRUE" : PRINTWHT "FALSE", PRINTWHT);
...
VOID KDUQuerySpecMitigationState() {
    ...
    NTSTATUS ntStatus = NtQuerySystemInformation(
        SystemKernelVaShadowInformation, &KvaShadowInfo, sizeof(KvaShadowInfo),
        &bytesIO);

    if (NT_SUCCESS(ntStatus)) {
        printf_s("\t>> SystemKernelVaShadowInformation\r\n");
        KDUPrintBooleanValueWithColor(
            "KvaShadowEnabled", KvaShadowInfo.KvaShadowFlags.KvaShadowEnabled);
        KDUPrintBooleanValueWithColor(
            "KvaShadowUserGlobal",
            KvaShadowInfo.KvaShadowFlags.KvaShadowUserGlobal);
        KDUPrintBooleanValueWithColor(
            "KvaShadowPcid", KvaShadowInfo.KvaShadowFlags.KvaShadowPcid);
        KDUPrintBooleanValueWithColor(
            "KvaShadowInvpcid", KvaShadowInfo.KvaShadowFlags.KvaShadowInvpcid);
        KDUPrintBooleanValueWithColor(
            "KvaShadowRequired",
            KvaShadowInfo.KvaShadowFlags.KvaShadowRequired);
        KDUPrintBooleanValueWithColor(
            "KvaShadowRequiredAvailable",
            KvaShadowInfo.KvaShadowFlags.KvaShadowRequiredAvailable);
        printf_s("\tInvalidPteBit %lu\r\n",
                 KvaShadowInfo.KvaShadowFlags.InvalidPteBit);
        KDUPrintBooleanValueWithColor(
            "L1DataCacheFlushSupported",
            KvaShadowInfo.KvaShadowFlags.L1DataCacheFlushSupported);
        KDUPrintBooleanValueWithColor(
            "L1TerminalFaultMitigationPresent",
            KvaShadowInfo.KvaShadowFlags.L1TerminalFaultMitigationPresent);
    ...
    ntStatus = NtQuerySystemInformation(SystemSpeculationControlInformation,
                                        &SpecControlInfo, bytesIO, &bytesIO);

    if (ntStatus == STATUS_NOT_IMPLEMENTED ||
        ntStatus == STATUS_INVALID_INFO_CLASS) {
        supShowHardError("Speculation control information class not present",
                         ntStatus);
    } else if (ntStatus != STATUS_SUCCESS) {
        supShowHardError("Cannot query speculation control information",
                         ntStatus);
    } else {
        ...
        KDUPrintBooleanValueWithColor(
            "BpbEnabled",
            SpecControlInfo.v1.SpeculationControlFlags.BpbEnabled);
        KDUPrintBooleanValueWithColor(
            "BpbDisabledSystemPolicy",
            SpecControlInfo.v1.SpeculationControlFlags.BpbDisabledSystemPolicy);
        KDUPrintBooleanValueWithColor("BpbDisabledNoHardwareSupport",
                                      SpecControlInfo.v1.SpeculationControlFlags
                                          .BpbDisabledNoHardwareSupport);
        KDUPrintBooleanValueWithColor(
            "SpecCtrlEnumerated",
            SpecControlInfo.v1.SpeculationControlFlags.SpecCtrlEnumerated);
        KDUPrintBooleanValueWithColor(
            "SpecCmdEnumerated",
            SpecControlInfo.v1.SpeculationControlFlags.SpecCmdEnumerated);
        KDUPrintBooleanValueWithColor(
            "IbrsPresent",
            SpecControlInfo.v1.SpeculationControlFlags.IbrsPresent);
        KDUPrintBooleanValueWithColor(
            "StibpPresent",
            SpecControlInfo.v1.SpeculationControlFlags.StibpPresent);
        KDUPrintBooleanValueWithColor(
            "SmepPresent",
            SpecControlInfo.v1.SpeculationControlFlags.SmepPresent);
        KDUPrintBooleanValueWithColor(
        ...
        KDUPrintBooleanValueWithColor(
            ...
            SpecControlInfo.v1.SpeculationControlFlags.BpbDisabledKernelToUser);
        KDUPrintBooleanValueWithColor("SpecCtrlRetpolineEnabled",
                                      SpecControlInfo.v1.SpeculationControlFlags
                                          .SpecCtrlRetpolineEnabled);
        KDUPrintBooleanValueWithColor("SpecCtrlImportOptimizationEnabled",
                                      SpecControlInfo.v1.SpeculationControlFlags
                                          .SpecCtrlImportOptimizationEnabled);
        KDUPrintBooleanValueWithColor(
            "EnhancedIbrs",
            SpecControlInfo.v1.SpeculationControlFlags.EnhancedIbrs);
        KDUPrintBooleanValueWithColor(
            "HvL1tfStatusAvailable",
            SpecControlInfo.v1.SpeculationControlFlags.HvL1tfStatusAvailable);
        KDUPrintBooleanValueWithColor("HvL1tfProcessorNotAffected",
                                      SpecControlInfo.v1.SpeculationControlFlags
                                          .HvL1tfProcessorNotAffected);
        KDUPrintBooleanValueWithColor(
            "HvL1tfMigitationEnabled",
            SpecControlInfo.v1.SpeculationControlFlags.HvL1tfMigitationEnabled);
        KDUPrintBooleanValueWithColor("HvL1tfMigitationNotEnabled_Hardware",
                                      SpecControlInfo.v1.SpeculationControlFlags
                                          .HvL1tfMigitationNotEnabled_Hardware);
        KDUPrintBooleanValueWithColor(
            "HvL1tfMigitationNotEnabled_LoadOption",
            SpecControlInfo.v1.SpeculationControlFlags
                .HvL1tfMigitationNotEnabled_LoadOption);
        KDUPrintBooleanValueWithColor(
            "HvL1tfMigitationNotEnabled_CoreScheduler",
            SpecControlInfo.v1.SpeculationControlFlags
                .HvL1tfMigitationNotEnabled_CoreScheduler);
        KDUPrintBooleanValueWithColor(
            "EnhancedIbrsReported",
            SpecControlInfo.v1.SpeculationControlFlags.EnhancedIbrsReported);
        KDUPrintBooleanValueWithColor(
            "MdsHardwareProtected",
            SpecControlInfo.v1.SpeculationControlFlags.MdsHardwareProtected);
        KDUPrintBooleanValueWithColor(
            "MbClearEnabled",
            SpecControlInfo.v1.SpeculationControlFlags.MbClearEnabled);
        KDUPrintBooleanValueWithColor(
            "MbClearReported",
            SpecControlInfo.v1.SpeculationControlFlags.MbClearReported);
        printf_s("\t\tTsxCtrlStatus %lu\r\n",
                 SpecControlInfo.v1.SpeculationControlFlags.TsxCtrlStatus);
        KDUPrintBooleanValueWithColor(
            "TsxCtrlReported",
            SpecControlInfo.v1.SpeculationControlFlags.TsxCtrlReported);
        KDUPrintBooleanValueWithColor(
            "TaaHardwareImmune",
            SpecControlInfo.v1.SpeculationControlFlags.TaaHardwareImmune);
        ...
        if (bytesIO == sizeof(SYSTEM_SPECULATION_CONTROL_INFORMATION_V2)) {
            ...
            KDUPrintBooleanValueWithColor(
                ...
                SpecControlInfo.v2.SpeculationControlFlags2
                    .SbdrSsdpHardwareProtected);
            KDUPrintBooleanValueWithColor(
                "FbsdpHardwareProtected",
                SpecControlInfo.v2.SpeculationControlFlags2
                    .FbsdpHardwareProtected);
            KDUPrintBooleanValueWithColor(
                "PsdpHardwareProtected",
                SpecControlInfo.v2.SpeculationControlFlags2
                    .PsdpHardwareProtected);
            KDUPrintBooleanValueWithColor(
                "FbClearEnabled",
                SpecControlInfo.v2.SpeculationControlFlags2.FbClearEnabled);
            KDUPrintBooleanValueWithColor(
                "FbClearReported",
                SpecControlInfo.v2.SpeculationControlFlags2.FbClearReported);
        }
    }
}
...
VOID KDUQueryProcessWorkingSet(_In_ ULONG_PTR SystemRangeStart,
                               _In_ PRTL_PROCESS_MODULES pvModules) {
    NTSTATUS ntStatus;

    ntStatus = NtSetInformationProcess(NtCurrentProcess(),
                                       ProcessWorkingSetWatch, NULL, 0);
    ...
    ntStatus =
        NtQueryInformationProcess(NtCurrentProcess(), ProcessWorkingSetWatchEx,
                                  (PVOID*)&watchInfo, sizeof(watchInfo), NULL);
    ...
    PVOID cookie;
    ntStatus = LdrLockLoaderLock(LDR_LOCK_LOADER_LOCK_FLAG_RAISE_ON_ERRORS,
                                 NULL, &cookie);
    ...
    if (NT_SUCCESS(ntStatus)) {
        ...
        for (ULONG i = 0; i < WATCH_COUNT; i++) {
            ...
            if ((ULONG_PTR)faultingPc >= SystemRangeStart) {
                ...
                if (supFindModuleEntryByAddress(pvModules, faultingPc,
                                                &moduleIndex)) {
                    if (NT_SUCCESS(ntsupConvertToUnicode(
                            (LPCSTR)pvModules->Modules[moduleIndex]
                                .FullPathName,
                            &pcModuleName))) {
                ...
                ntStatus = LdrFindEntryForAddress(
                    faultingPc, (PLDR_DATA_TABLE_ENTRY*)&entry);
                if (NT_SUCCESS(ntStatus))
            ...
            if ((ULONG_PTR)faultingVa >= SystemRangeStart) {
                ...
                if (supFindModuleEntryByAddress(pvModules, faultingVa,
                                                &moduleIndex)) {
                    if (NT_SUCCESS(ntsupConvertToUnicode(
                            (LPCSTR)pvModules->Modules[moduleIndex]
                                .FullPathName,
                ...
                ntStatus = LdrFindEntryForAddress(
                    faultingVa, (PLDR_DATA_TABLE_ENTRY*)&entry);
                if (NT_SUCCESS(ntStatus))
                    vaName = entry->BaseDllName.Buffer;
            }

            printf_s("\t>> ThreadId [%llu] Pc %p (%ws) : Va %p (%ws)\r\n",
                     watchInfo[i].FaultingThreadId, faultingPc, pcName,
                     faultingVa, vaName);

            if (pcModuleName.Buffer)
                RtlFreeUnicodeString(&pcModuleName);
            if (vaModuleName.Buffer)
                RtlFreeUnicodeString(&vaModuleName);
        }
...
VOID TraceHandle(_In_ ULONG_PTR SystemRangeStart,
                 _In_ HANDLE Handle,
                 _In_ PRTL_PROCESS_MODULES pvModules) {
    NTSTATUS ntStatus;
    ...
    ntStatus = NtQueryInformationProcess(
        NtCurrentProcess(), ProcessHandleTracing, &trace, sizeof(trace), NULL);
    if (NT_SUCCESS(ntStatus)) {
        for (ULONG i = 0; i < trace.TotalTraces; i++) {
            for (ULONG j = 0; j < PROCESS_HANDLE_TRACING_MAX_STACKS; j++) {
                ...
                if (supFindModuleEntryByAddress(pvModules, stackAddress,
                                                &moduleIndex)) {
                    ...
                    if ((ULONG_PTR)stackAddress >= SystemRangeStart) {
                        ...
                        ntStatus = LdrLockLoaderLock(
                            LDR_LOCK_LOADER_LOCK_FLAG_RAISE_ON_ERRORS, NULL,
                            &cookie);
                        ...
                        if (NT_SUCCESS(ntStatus)) {
                            ...
                            ntStatus = LdrFindEntryForAddress(
                                stackAddress, (PLDR_DATA_TABLE_ENTRY*)&entry);
                            if (NT_SUCCESS(ntStatus)) {
                                printf_s("\t>> 0x%p, %wZ, base 0x%p\r\n",
                                         stackAddress, entry->BaseDllName,
                                         entry->DllBase);
                            } else {
                                printf_s("\t>> 0x%p, !UNKNOWN! module\r\n",
                                         stackAddress);
                            ...
                            supShowHardError("Failed to acquire loader lock",
                                             ntStatus);
                        }
                    }
                }
...
VOID TracePsHandle(_In_ PCLIENT_ID ClientId,
    ...
    ntStatus =
        NtOpenProcess(&objectHandle, PROCESS_ALL_ACCESS, &obja, &clientId);
    if (NT_SUCCESS(ntStatus)) {
        TraceHandle(SystemRangeStart, objectHandle, pvModules);
...
VOID TraceSectionHandle(_In_ ULONG_PTR SystemRangeStart,
                        _In_ PRTL_PROCESS_MODULES pvModules) {
    NTSTATUS ntStatus;
    ...
    InitializeObjectAttributes(&obja, &usName, OBJ_CASE_INSENSITIVE, NULL,
                               NULL);

    ntStatus =
        NtOpenFile(&fileHandle, SYNCHRONIZE | FILE_EXECUTE, &obja, &iost,
    ...
    ntStatus = NtCreateSection(&sectionHandle, SECTION_ALL_ACCESS, &obja, NULL,
...
#define IOCTL_FLTMGR_LINK_HANDLE                                      \
    CTL_CODE(FILE_DEVICE_DISK_FILE_SYSTEM, FLTMGR_LINK_HANDLE_FUNCID, \
             METHOD_BUFFERED, FILE_READ_ACCESS)
#define IOCTL_FLTMGR_FIND_FIRST                                      \
    CTL_CODE(FILE_DEVICE_DISK_FILE_SYSTEM, FLTMGR_FIND_FIRST_FUNCID, \
             METHOD_BUFFERED, FILE_READ_ACCESS)
#define IOCTL_FLTMGR_FIND_NEXT                                      \
    CTL_CODE(FILE_DEVICE_DISK_FILE_SYSTEM, FLTMGR_FIND_NEXT_FUNCID, \
             METHOD_BUFFERED, FILE_READ_ACCESS)

NTSTATUS KDUpFilterFindFirst(_In_ HANDLE FltMgrHandle,
    ...
    ntStatus =
        supFilterDeviceIoControl(FltMgrHandle, IOCTL_FLTMGR_LINK_HANDLE,
                                 &linkInfo, sizeof(linkInfo), NULL, 0, NULL);

    if (NT_SUCCESS(ntStatus)) {
        ntStatus = supFilterDeviceIoControl(
            FltMgrHandle, IOCTL_FLTMGR_FIND_FIRST, &infoClass,
            sizeof(infoClass), Buffer, BufferSize, NULL);
    }

    return ntStatus;
}

NTSTATUS KDUpFilterFindNext(_In_ HANDLE FltMgrHandle,
                            _In_ FILTER_INFORMATION_CLASS InformationClass,
                            _In_ PVOID Buffer,
                            _In_ ULONG BufferSize) {
    FILTER_INFORMATION_CLASS infoClass = InformationClass;

    return supFilterDeviceIoControl(FltMgrHandle, IOCTL_FLTMGR_FIND_NEXT,
                                    &infoClass, sizeof(infoClass), Buffer,
                                    BufferSize, NULL);
}
...
VOID KDUListFilters() {
    ...
    if (buffer) {
        ...
        InitializeObjectAttributes(&obja, &usDeviceName, OBJ_CASE_INSENSITIVE,
                                   NULL, NULL);

        ntStatus = NtCreateFile(&fltMgrHandle, GENERIC_READ, &obja, &iost, NULL,
                                FILE_ATTRIBUTE_NORMAL, FILE_SHARE_READ,
                                FILE_OPEN, 0, NULL, 0);

        if (!NT_SUCCESS(ntStatus)) {
            supPrintfEvent(kduEventError,
                           "Cannot open %wZ, NTSTATUS (0x%lX)\r\n",
                           usDeviceName, ntStatus);
            supHeapFree(buffer);
            return;
        }

        if (NT_SUCCESS(KDUpFilterFindFirst(fltMgrHandle, FilterFullInformation,
                                           buffer, bufferSize))) {
            do {
                printf_s("\t>> %ws\r\n", buffer->FilterNameBuffer);
                RtlSecureZeroMemory(buffer, bufferSize);

            } while (KDUpFilterFindNext(fltMgrHandle, FilterFullInformation,
                                        buffer,
                                        bufferSize) != STATUS_NO_MORE_ENTRIES);
        }
...
VOID KDUBacktraceByHandle(_In_ ULONG_PTR SystemRangeStart,
                          _In_ PRTL_PROCESS_MODULES pvModules) {
    NTSTATUS ntStatus;
    CLIENT_ID cid;
    PVOID procBuffer;
    ...
    ntStatus = NtSetInformationProcess(NtCurrentProcess(), ProcessHandleTracing,
                                       &traceEnable, sizeof(traceEnable));
    ...
    if (List.ListRef) {
        ...
        do {
            ...
            if (RtlEqualUnicodeString(&usLsass, &List.Process->ImageName,
                                      TRUE)) {
        ...
        supPrintfEvent(
            kduEventError,
            "Cannot allocate process list, process trace unavailable\r\n");
    }

    TraceSectionHandle(SystemRangeStart, pvModules);
}

VOID KDUListObjects(VOID) {
...
VOID KDUListDrivers(_In_ PRTL_PROCESS_MODULES pvModules) {
    ...
    for (ULONG i = 0; i < pList->Count; i++) {
        ...
        for (ULONG j = 0; j < pDesc->PartialResourceList.Count; j++) {
            ...
            if (pPartialDesc->Type == CmResourceTypeMemory ||
                ...
                printf_s(
                    "#%lu Flags 0x%04lX 0x%016llX::0x%016llX (length "
                    "0x%016llX, %llu Mb)\r\n",
                    j, pPartialDesc->Flags,
                    pPartialDesc->u.Memory.Start.QuadPart,
                    pPartialDesc->u.Memory.Start.QuadPart + length, length,
                    length / 1024 / 1024);

            } else {
                printf_s("#%lu Type 0x%04lX, Flags 0x%04lX\r\n", j,
                         pPartialDesc->Type, pPartialDesc->Flags);
            }
        }
    }
    supHeapFree(pList);
...
VOID KDUDiagStart() {
    ...
    __try {
        ...
        if (pvModules) {
            ...
            printf_s(
                "> List of device and driver objects in the common "
                "locations\r\n");
            KDUListObjects();
        ...
        supPrintfEvent(kduEventError,
                       "Exception (0x%lX) during diagnostics\r\n",
                       GetExceptionCode());
    }
