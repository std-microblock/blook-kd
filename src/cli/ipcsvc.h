...
typedef VOID(CALLBACK* IpcOnReceive)(_In_ PCLIENT_ID ClientId,
                                     _In_ PKDU_MSG Message,
                                     _In_opt_ PVOID UserContext);

typedef VOID(CALLBACK* IpcOnConnect)(_In_ PCLIENT_ID ClientId,
                                     _In_ BOOLEAN ConnectionAccepted,
                                     _In_opt_ PVOID UserContext);

typedef VOID(CALLBACK* IpcOnException)(_In_ ULONG ExceptionCode,
                                       _In_opt_ PVOID UserContext);

typedef VOID(CALLBACK* IpcOnPortClose)(_In_ HANDLE PortHandle,
                                       _In_opt_ PVOID UserContext);
