...
// The derivatives are all the same and exceptionally bugged as well, e.g.
// MalwareFox, WatchDog Anti-Malware etc.
//
...
#define IOCTL_ZEMANA_REGISTER_PROCESS                                      \
    CTL_CODE(FILE_DEVICE_ZEMANA, ZEMANA_REGISTER_PROCESS, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x80002010

#define IOCTL_ZEMANA_SCSI_READ                                      \
    CTL_CODE(FILE_DEVICE_ZEMANA, ZEMANA_SCSI_READ, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x80002014

#define IOCTL_ZEMANA_SCSI_WRITE                                      \
    CTL_CODE(FILE_DEVICE_ZEMANA, ZEMANA_SCSI_WRITE, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x80002018

#define IOCTL_ZEMANA_SAVE_MINIPORT_FIX                                      \
    CTL_CODE(FILE_DEVICE_ZEMANA, ZEMANA_SAVE_MINIPORT_FIX, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x80002044

#define IOCTL_ZEMANA_PROTECT_REGISTRY                                      \
    CTL_CODE(FILE_DEVICE_ZEMANA, ZEMANA_PROTECT_REGISTRY, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x80002040

#define IOCTL_ZEMANA_OPEN_PROCESS                                      \
    CTL_CODE(FILE_DEVICE_ZEMANA, ZEMANA_OPEN_PROCESS, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x8000204C
