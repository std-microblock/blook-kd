...
#define IOCTL_EVGA_ELEETX1_READ_PHYSMEM                                   \
    CTL_CODE(EVGA_ELEETX1_DEVICE_TYPE, EVGA_ELEETX1_FUNCTION_READPHYSMEM, \
             METHOD_BUFFERED, FILE_READ_ACCESS)  // 0x80006414

#define IOCTL_EVGA_ELEETX1_WRITE_PHYSMEM                                   \
    CTL_CODE(EVGA_ELEETX1_DEVICE_TYPE, EVGA_ELEETX1_FUNCTION_WRITEPHYSMEM, \
             METHOD_BUFFERED, FILE_READ_ACCESS)  // 0x80006418
