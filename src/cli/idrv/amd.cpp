 ...
 *
 */
BOOL RmValidatePrerequisites(_In_ KDU_CONTEXT* Context) {
    BOOL bResult;
 ...
 *
 */
BOOL WINAPI RmReadPhysicalMemory(_In_ HANDLE DeviceHandle,
    ...
    pRequest = (RMDRV_REQUEST*)supAllocateLockedMemory(
    ...
    if (pRequest) {
        ...
        bResult = supCallDriver(DeviceHandle, IOCTL_AMDRM_READ_MEMORY, pRequest,
                                sizeof(RMDRV_REQUEST), pRequest, (ULONG)size);
 ...
 *
 */
BOOL WINAPI RmWritePhysicalMemory(_In_ HANDLE DeviceHandle,
                                  _In_ ULONG_PTR PhysicalAddress,
                                  _In_ PVOID Buffer,
                                  _In_ ULONG NumberOfBytes) {
    BOOL bResult = FALSE;
    ...
    if (pRequest) {
        ...
        RtlCopyMemory(RtlOffsetToPointer(pRequest, sizeof(RMDRV_REQUEST)),
                      Buffer, NumberOfBytes);

        bResult = supCallDriver(DeviceHandle, IOCTL_AMDRM_WRITE_MEMORY,
 ...
 *
 */
BOOL WINAPI PdFwReadVirtualMemory(_In_ HANDLE DeviceHandle,
    ...
    return supCallDriver(DeviceHandle, IOCTL_AMDPDFW_MEMCPY, &request,
 ...
 *
 */
BOOL WINAPI PdFwWriteVirtualMemory(_In_ HANDLE DeviceHandle,
                                   _In_ ULONG_PTR Address,
