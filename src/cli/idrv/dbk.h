...
#define IOCTL_CE_ALLOCATEMEM_NONPAGED                                         \
    CTL_CODE(DBK_DEVICE_TYPE, DBK_FUNC_ALLOCATEMEM_NONPAGED, METHOD_BUFFERED, \
             FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IOCTL_CE_FREEMEM                                         \
    CTL_CODE(DBK_DEVICE_TYPE, DBK_FUNC_FREEMEM, METHOD_BUFFERED, \
             FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IOCTL_CE_MAP_MEMORY                                         \
    CTL_CODE(DBK_DEVICE_TYPE, DBK_FUNC_MAP_MEMORY, METHOD_BUFFERED, \
             FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IOCTL_CE_UNMAP_MEMORY                                         \
    CTL_CODE(DBK_DEVICE_TYPE, DBK_FUNC_UNMAP_MEMORY, METHOD_BUFFERED, \
             FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IOCTL_CE_EXECUTE_CODE                                         \
    CTL_CODE(DBK_DEVICE_TYPE, DBK_FUNC_EXECUTE_CODE, METHOD_BUFFERED, \
             FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IOCTL_CE_OPENPROCESS                                          \
    CTL_CODE(DBK_DEVICE_TYPE, DBK_FUNC_OPEN_PROCESS, METHOD_BUFFERED, \
             FILE_READ_ACCESS | FILE_WRITE_ACCESS)
