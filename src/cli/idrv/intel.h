/* Intel drivers interface header. Network Adapter iQVM64 driver aka Nal
...
#define IOCTL_NAL_MANAGE                                               \
    CTL_CODE(INTEL_DEVICE_TYPE, INTEL_DEVICE_FUNCTION, METHOD_NEITHER, \
             FILE_ANY_ACCESS)  // 0x80862007
...
#define IOCTL_PMXDRV_MAP_MEMORY                                       \
    CTL_CODE(FILE_DEVICE_UNKNOWN, PMXDRV_MAP_FUNCID, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x00222AB8

#define IOCTL_PMXDRV_UNMAP_MEMORY                                       \
    CTL_CODE(FILE_DEVICE_UNKNOWN, PMXDRV_UNMAP_FUNCID, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x00222ABC
...
BOOL NalVirtualToPhysical(_In_ HANDLE DeviceHandle,
                          _In_ ULONG_PTR VirtualAddress,
