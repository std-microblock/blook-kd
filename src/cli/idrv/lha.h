...
#define IOCTL_LHA_READ_PHYSICAL_MEMORY                                  \
    CTL_CODE(LHA_DEVICE_TYPE, LHA_READ_PHYSMEM_FUNCID, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x9C402FD8

#define IOCTL_LHA_WRITE_PHYSICAL_MEMORY                                  \
    CTL_CODE(LHA_DEVICE_TYPE, LHA_WRITE_PHYSMEM_FUNCID, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x9C402FDC
...
BOOL WINAPI LHAQueryPML4Value(_In_ HANDLE DeviceHandle, _Out_ ULONG_PTR* Value);
