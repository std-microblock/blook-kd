...
#define IOCTL_NVOCLOCK_DISPATCH                                        \
    CTL_CODE(FILE_DEVICE_NVOCLOCK, NVOCLOCK_DISPATCH, METHOD_BUFFERED, \
             FILE_WRITE_ACCESS)  // 0x9C40A484

//
// Multipurpose structure, other defines are irrelevant, size is 0x138 and
// checked in handlers.
//
