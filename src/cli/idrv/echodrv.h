...
//
// Echo.ac driver uses a ridiculous IOCTL scheme which could be a side effect of
// intense copy-paste.
//
...
#define IOCTL_ECHODRV_REGISTER                                                \
    CTL_CODE(ECHODRV_DEVICE_TYPE, ECHODRV_FUNCTION_REGISTER, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x9E6A0594

#define IOCTL_ECHODRV_OPEN_PROCESS                                    \
    CTL_CODE(ECHODRV_INTERFACE_TYPE_1, ECHODRV_FUNCTION_OPEN_PROCESS, \
             METHOD_BUFFERED, FILE_READ_ACCESS)  // 0xE6224248

#define IOCTL_ECHODRV_COPYVM                                    \
    CTL_CODE(ECHODRV_INTERFACE_TYPE_2, ECHODRV_FUNCTION_COPYVM, \
             METHOD_BUFFERED, FILE_READ_ACCESS)  // 0x60A26124
