...
#define IOCTL_GDRV_VIRTUALTOPHYSICAL                                    \
    CTL_CODE(GDRV_DEVICE_TYPE, GDRV_VIRTUALTOPHYSICAL, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0xC350280C

#define IOCTL_GDRV_MAP_USER_PHYSICAL_MEMORY                          \
    CTL_CODE(GDRV_DEVICE_TYPE, GRV_IOCTL_INDEX + 1, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0xC3502004

#define IOCTL_GDRV_UNMAP_USER_PHYSICAL_MEMORY                        \
    CTL_CODE(GDRV_DEVICE_TYPE, GRV_IOCTL_INDEX + 2, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0xC3502008
...
#define IOCTL_SUPERBMC_MAP_USER_PHYSICAL_MEMORY                          \
    CTL_CODE(SUPERBMC_DEVICE_TYPE, SUPERBMC_MAP_FUNCID, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x80102238

#define IOCTL_SUPERBMC_UNMAP_USER_PHYSICAL_MEMORY                          \
    CTL_CODE(SUPERBMC_DEVICE_TYPE, SUPERBMC_UNMAP_FUNCID, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x80102240
...
#define IOCTL_MAPMEM_MAP_USER_PHYSICAL_MEMORY                         \
    CTL_CODE(FILE_DEVICE_MAPMEM, MAPMEM_IOCTL_INDEX, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)

#define IOCTL_MAPMEM_UNMAP_USER_PHYSICAL_MEMORY                           \
    CTL_CODE(FILE_DEVICE_MAPMEM, MAPMEM_IOCTL_INDEX + 1, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)
