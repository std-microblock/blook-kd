...
#define IOCTL_ALCPU_READ_MEMORY                                     \
    CTL_CODE(FILE_DEVICE_ALCPU, ALCPU_READ_MEMORY, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x9C402618

#define IOCTL_ALCPU_WRITE_MEMORY                                     \
    CTL_CODE(FILE_DEVICE_ALCPU, ALCPU_WRITE_MEMORY, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x9C40261C
