...
#define IOCTL_DBUTIL_READVM                                               \
    CTL_CODE(DBUTIL_DEVICE_TYPE, DBUTIL_FUNCTION_READVM, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x9B0C1EC4

#define IOCTL_DBUTIL_WRITEVM                                               \
    CTL_CODE(DBUTIL_DEVICE_TYPE, DBUTIL_FUNCTION_WRITEVM, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x9B0C1EC8

#define IOCTL_PCDCSRVC_REGISTER                                                \
    CTL_CODE(FILE_DEVICE_UNKNOWN, PCDCSRVC_FUNCTION_REGISTER, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x222004

#define IOCTL_PCDCSRVC_READPHYSMEM                                             \
    CTL_CODE(FILE_DEVICE_UNKNOWN, PCDCSRVC_FUNCTION_READPHYS, METHOD_BUFFERED, \
             FILE_ANY_ACCESS)  // 0x222084

#define IOCTL_PCDCSRVC_WRITEPHYSMEM                            \
    CTL_CODE(FILE_DEVICE_UNKNOWN, PCDCSRVC_FUNCTION_WRITEPHYS, \
             METHOD_BUFFERED, FILE_ANY_ACCESS)  // 0x222088
