...
typedef BOOL(WINAPI* pfnVictimCreate)(_In_opt_ HINSTANCE ModuleBase,
                                      _In_ LPCWSTR Name,
...
typedef BOOL(WINAPI* pfnVictimRelease)(_In_ LPCWSTR Name);

typedef VOID(WINAPI* pfnVictimExecute)(_In_ LPCWSTR Name,
                                       _In_ ACCESS_MASK DesiredAccess,
                                       _Out_opt_ PHANDLE VictimHandle);
